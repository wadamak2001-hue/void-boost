...
export default function Home() {
  ...
  if (showSplash) {
    return (
      <div className="fixed inset-0 bg-background flex flex-col items-center justify-center z-[100] transition-opacity duration-1000">
        ...
        <h1 className="mt-8 font-headline text-4xl font-black tracking-tighter neon-text animate-pulse">
          VOID <span className="text-primary">BOOST</span>
        </h1>
        <p className="mt-2 text-muted-foreground font-headline tracking-[0.3em] text-[10px] uppercase opacity-60">
          Hyper-Optimized Gaming
        </p>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen max-w-md mx-auto bg-[#0A0C12] relative flex flex-col overflow-hidden pb-12">
      ...
      <header className="p-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-headline font-black text-xl leading-none">VOID BOOST</h1>
            <p className="text-[10px] text-primary font-bold tracking-widest">SYSTEM ONLINE</p>
          </div>
        </div>
