...
export function GitHubDeployer() {
  ...
  const handleDeploy = async () => {
    ...
    try {
      ...
      logger.add("SUCCESS: Configuration verified. APK will be at: android/app/build/outputs/apk/debug/app-debug.apk", 'success')
      
      toast({
        title: "READY TO PUSH",
        description: "Push code to GitHub. Your APK will be at android/app/build/outputs/apk/debug/app-debug.apk",
